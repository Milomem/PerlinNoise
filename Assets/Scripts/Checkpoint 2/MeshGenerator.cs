...
public static class MeshGenerator {
	...
	public static MeshData GenerateTerrainMesh(float[,] heightMap, MeshSettings meshSettings, int levelOfDetail) {
		...
		// Adiciona vértices e triângulos à malha
		for (int y = 0; y < numVertsPerLine; y++) {
			for (int x = 0; x < numVertsPerLine; x++) {
				bool isSkippedVertex = x > 2 && x < numVertsPerLine - 3 && y > 2 && y < numVertsPerLine - 3 && ((x - 2) % skipIncrement != 0 || (y - 2) % skipIncrement != 0);
...
// Classe que armazena dados da malha
public class MeshData {
	...
	// Construtor para inicializar os dados da malha
	...
	// Calcula a normal da superfície a partir dos índices dos vértices
	...
	// Processa a malha para calcular as normais
	...
	// Calcula as normais para sombreamento plano
	void BakeNormals() {
		bakedNormals = CalculateNormals();
	}

	// Aplica sombreamento plano à malha
	void FlatShading() {
